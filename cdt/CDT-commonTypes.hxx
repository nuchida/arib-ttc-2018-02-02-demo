...
namespace onem2m
{
  ...
  /**
   * @brief Class corresponding to the %primitiveContent schema type.
   *
   * @nosubgrouping
   */
...
namespace onem2m
{
  ...
  /**
   * @name Parsing functions for the %primitiveContent document root.
   */
  //@{
...
namespace onem2m
{
  ...
  /**
   * @name Serialization functions for the %primitiveContent document root.
   */
  //@{
